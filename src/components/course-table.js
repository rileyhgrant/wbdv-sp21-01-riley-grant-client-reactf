...
export default class CourseTable extends React.Component {
    ...
    render() {
        return (
            <div>
                {/* <Link to="/manager/grid"><i className="fas fa-table float-right"></i></Link> */}

                {/* create a table and add all of data from the state to it */}
                <table className="table">
                    ...
                    <tbody>
                        <tr className="">
                            ...
                            <td className=""><h5>Last Modified</h5></td>
                            <td className="">
