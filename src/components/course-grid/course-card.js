    ...
    <div class="card m-2" style={{ width: "18rem" }}>
      ...
      <div class="card-body">
        ...
        <div>
          ...
          {!editing && (
            <i
              onClick={() => cardFunctions.editCourse()}
              className="fas fa-edit float-right m-1"
            ></i>
          )}
          {editing && (
            <i
              onClick={() => cardFunctions.deleteCourse()}
              className="fas fa-trash float-right m-1"
            ></i>
          )}
          {editing && (
            <i
              onClick={() => cardFunctions.updateCourse()}
              className="fas fa-check float-right m-1"
            ></i>
          )}
          <div>
            <Link
